...
class UserCreateView(SuperuserAndLoginRequiredMixin, GuestAccessMixin, generic.CreateView):
...
class UserUpdateView(SuperuserAndLoginRequiredMixin, GuestAccessMixin, generic.UpdateView):
...
class UserDeleteView(SuperuserAndLoginRequiredMixin, GuestAccessMixin, generic.DeleteView):
